...
export declare class StripeSync {
    ...
    syncSingleEntity(stripeId: string): Promise<Stripe.Charge[] | (Stripe.Customer | Stripe.DeletedCustomer)[] | Stripe.Subscription[] | Stripe.TaxId[] | Stripe.Invoice[] | Stripe.Product[] | Stripe.Price[] | Stripe.SetupIntent[] | Stripe.PaymentMethod[] | Stripe.Dispute[] | Stripe.PaymentIntent[] | Stripe.CreditNote[] | undefined>;
    ...
    upsertCustomers(customers: (Stripe.Customer | Stripe.DeletedCustomer)[]): Promise<(Stripe.Customer | Stripe.DeletedCustomer)[]>;
    backfillCustomers(customerIds: string[]): Promise<void>;
    upsertDisputes(disputes: Stripe.Dispute[], backfillRelatedEntities?: boolean): Promise<Stripe.Dispute[]>;
    upsertInvoices(invoices: Stripe.Invoice[], backfillRelatedEntities?: boolean): Promise<Stripe.Invoice[]>;
    ...
    upsertPaymentIntents(paymentIntents: Stripe.PaymentIntent[], backfillRelatedEntities?: boolean): Promise<Stripe.PaymentIntent[]>;
    upsertPaymentMethods(paymentMethods: Stripe.PaymentMethod[], backfillRelatedEntities?: boolean): Promise<Stripe.PaymentMethod[]>;
    upsertSetupIntents(setupIntents: Stripe.SetupIntent[], backfillRelatedEntities?: boolean): Promise<Stripe.SetupIntent[]>;
    ...
    upsertSubscriptionSchedules(subscriptionSchedules: Stripe.SubscriptionSchedule[], backfillRelatedEntities?: boolean): Promise<Stripe.SubscriptionSchedule[]>;
    upsertSubscriptions(subscriptions: Stripe.Subscription[], backfillRelatedEntities?: boolean): Promise<Stripe.Subscription[]>;
