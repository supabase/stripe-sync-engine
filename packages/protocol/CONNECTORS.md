...
This guide covers how to implement a new source or destination using `@tx-stripe/protocol`.
...
packages/source-example/
  ...
  package.json    # depends on @tx-stripe/protocol
```
...
import { toRecordMessage } from '@tx-stripe/protocol'
...
```ts
import { z } from 'zod'
import type { Destination } from '@tx-stripe/protocol'
