...
describe('formatProgress', () => {
  ...
  it('formats active sync with many streams', () => {
    const progress: ProgressPayload = {
      ...
      derived: {
        status: 'started',
        records_per_second: 245.2,
        states_per_second: 1.5,
        total_record_count: 3451,
  ...
  it('shows deltas when previous progress is provided', () => {
    ...
    const current: ProgressPayload = {
      ...
      derived: {
        ...
        states_per_second: 1.25,
        total_record_count: 450,
        total_state_count: 5,
      },
      streams: {
