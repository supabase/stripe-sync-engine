import type { SyncParams as SyncParamsType } from './lib/index.js'
import { SyncParams } from './lib/index.js'
import { envPrefix, mergeConfig, parseJsonOrFile, parseStreams } from '@stripe/sync-ts-cli'
